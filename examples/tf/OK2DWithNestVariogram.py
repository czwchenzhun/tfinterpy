...
if __name__ == "__main__":
    ...
    with tf.device("/GPU:0"):
        grid.pro, grid.sigma = exe.execute(grid.points(), N, nestVariogramLayer, 10000)

    print(exe.crossValidateKFold(10, N, nestVariogramLayer))
    print(exe.crossValidate(N, nestVariogramLayer))
